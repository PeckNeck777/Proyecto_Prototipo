...
.-------------------.
 ...
 [Ver 1.1.2]
.-------------------.
Pink models everywhere?
Working with URP (Universal Render Pipeline)?
Check "URP-Unity" to see how to natively fix everything with 2 or 3 clicks in no time!
(image located in the root directory of this asset)
.-------------------.
...
(Scroll down for further details)
 ...
 [Changelog]
 [Update 1.1.2]
 - Prefabs updated with colliders
 - Unity Demo Scene included
 - Added a few more model alternatives, as well as new painting texture variants.
 - Fixed some of the models.
 - Redo majority of the UVs and palettes, matching my newest sets. The Unity version was redo in order to match the changes.
...
--- Built-in to URP (pink materials, pink everything) ---

If you're new to Unity, you surely created your new project following the most recent standard: using URP - this means you need to convert materials from Built-in to URP, this can be done in a matter of 2-3 clicks, in about 3 steps, from within Unity, natively and without the need of any additional tool. Feel free to check the image "URP-Unity" for a quick visual guide!

.-------------------.

[*Extra Content available for those who support me on itch.io*]
...
----------         06-2025         ----------
If you liked the first 2 free office sets, want more and also want to support my work, you can check (and maybe buy) my 440+ individual models Office Set #3, with all new furniture options, including lots of new kind of models and multiple textures, with dedicated support!
---------- 
...
Contact me here:
- https://vnb3d.com/contact/ (Official Website)
- https://vnbp.itch.io/ (Itch.io)
- https://assetstore.unity.com/publishers/120075 (Unity Asset Store)
